  ...
  <div class="resume">
    <div class="leftCol m_box">
      ...
      <div class="item last">
        ...
        <div class="skill" v-for="skill in person.skills" :key="skill">
          <div class="right">
    ...
    <div class="rightCol">
      ...
      <div class="section-headline">Kinh nghiệm làm việc</div>
      <div
        class="block"
      ...
      <div class="section-headline">Học vấn</div>
      <div class="block" v-for="education in person.education" :key="education">
        <div class="block-helper"></div>
    ...
    <div class="farRightCol">
      <div class="section-headline">Dự án đã làm</div>
      <div class="block" v-for="project in person.projects" :key="project">
        <div class="block-helper"></div>
        <div class="headline">
          <h3>{{ project.name }}</h3>
