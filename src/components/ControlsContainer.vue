<template>
  <section class="control-container">
    <h3 class="control-header">Component Props Controls</h3>
    ...
    <section class="item-container">
      ...
      >
        <section class="control">
          ...
          <input
            :class="
              control.inputType === 'checkbox' ? 'input-checkbox' : 'input-box'
            "
        ...
        <section class="options-container">
          <section class="options-item">
            <span class="options-title"> Type: </span>
        ...
        <section v-if="control.label === 'manual-pagination:'">
          <b>Note:</b> <br />
          When enabling this prop, the prop <br />
          <b> paginate-elements-by-height </b> will not be used. Instead the
          pagination process will rely on the elements with a class
          "html2pdf__page-break" to know where to page break.
        </section>
      </section>

      <div>
        <b>Note:</b> <br />
        There is a prop called <b>html-to-pdf-options</b>, if you set a value to
