<template>
  <div>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Quản lý công ty</v-toolbar-title>
...
<script>
import { getAllCompany, updateStatusCompany } from "@/api/company/company";
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Tên công ty", value: "companyName", width: 200 },
      { text: "Địa chỉ", value: "address", width: 200 },
      { text: "Website", value: "website", width: 100 },
      { text: "Số điện thoại", value: "phone", width: 100 },
      { text: "Người đại diện", value: "contact", width: 200 },
  ...
  methods: {
    ...
    updateStatus(status, item) {
      this.$swal
        .fire({
          title: "Bạn chắc chắn thay đổi trạng thái thông tin công ty này?",
          showDenyButton: true,
        ...
        .then((result) => {
          ...
          if (result.isConfirmed) {
            ...
            updateStatusCompany({ status, id: item.id }).then((response) => {
