            ...
            <v-container class="is-data-job">
                ...
                >
                    <v-row class="is-row-data">
                        <v-col cols="2">
                            <img :src="item.company.avatar" style="width: 150px; height: 150px; object-fit: cover;box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;"/>
                        </v-col>
                        <v-col cols="8">
                            <div class="content">
                                <v-row>
                                    <span style="font-weight:bold;font-size: 20px;">{{ item.jobTitle }}</span>
                                </v-row>
                                <v-row>
                                    <v-col cols="6" class="is-col-data">Mức lương: {{ item.salary }}</v-col>
                                    <v-col cols="6" class="is-col-data">Số lượng: {{ item.amountEmployee }}</v-col>
                                    <v-col cols="6" class="is-col-data">Hạn ứng tuyển: {{ formatDateRecruitment }}
                                    </v-col>
                                    <v-col cols="6" class="is-col-data">Địa điểm: {{ item.address }}</v-col>
                                </v-row>
