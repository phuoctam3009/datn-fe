<template>
    <div class="main">
            ...
            <v-container class="header">
                ...
                params: { companyId: data.company.id },
                    ...
                    <v-col cols="2" class="button-submit">
                        <v-btn dark style="float: right" color="green">
        ...
        <v-container class="content">
            ...
            <v-card class="job-detail" elevation="5" style="margin: 20px 0; padding: 20px 0 0 30px"  ref="company">
                <v-row>
            ...
            <v-card class="job-detail" elevation="5" style="margin-top: 30px" ref="jobRef">
