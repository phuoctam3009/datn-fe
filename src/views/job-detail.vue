    ...
    <section>
      <v-container>
        <p>
          ...
          with a broad set of technical skills who are ready to tackle some of
          ...
          solutions, large-scale applications and entirely new platforms for
        ...
        <p>
          ...
          Exercitationem laboriosam perspiciatis nihil, reprehenderit numquam ab
          minus deleniti illum laborum molestias corporis aut eum accusamus
          veritatis aspernatur ipsam ipsa delectus aliquid.
        </p>
        <ul>
          <li>
